...
class Network:
    """Network discovery client for finding Realtime API devices.
    ...
    Attributes:
        devices (Tuple[DiscoveredDeviceInfo, ...]): Currently discovered devices.
...
def is_valid_service_name(name: str) -> bool:
    """TODO: Why PI monitor where this comes from."""
