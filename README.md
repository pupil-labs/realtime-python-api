...
> [Pupil Core Network API](https://docs.pupil-labs.com/core/developer/network-api/)
...
The documentation is available at [pupil-labs.github.io/realtime-python-api](https://pupil-labs.github.io/realtime-python-api/).
